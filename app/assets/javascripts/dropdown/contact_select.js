    ...
    $.fn.dropdown = function(options) {
        ...
        return this.each(function() {
            ...
            function _chooseItem(option) {
                ...
                _closeDropdown();
                //$(".dropdown").css("width","125px;");
                //$(".dropdown").css("height","13px;;");
                if ((lvalue=="Non-Member")||(lvalue=="All")||(lvalue=="Member")||(lvalue=="Friend")||(lvalue=="All Contacts"))
                {
                $("#loadimg").show();    
                if (lvalue=="Non-Member")
                {
                   var keyval="non_member"
                }
                else if(lvalue=="All")
                {
                   var keyval="all"
                }
                else if(lvalue=="Member")
                {
                   var keyval="member"
                }
                else if(lvalue=="Friend")
                {
                   var keyval="friend"
                }
                else if(lvalue=="All Contacts")
                {
                   var keyval="all"
                }
                $.ajax({
                  ...
                  data: {"key_word":keyval}, // serializes the form's elements.
