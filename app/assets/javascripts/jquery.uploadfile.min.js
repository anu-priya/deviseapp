 ...
 */
    ...
    b.fn.uploadFile = function (t) {
        ...
        (function k() {
            if (b.fn.ajaxForm) {
                if (r.dragDrop) {
                    ...
                    var qq = b('<div id="ajax-upload-wrap" style="vertical-align:top;"></div>');
        ...
        function h(u, w) {
		    ...
		    //var z = s[0] + u.fileCounterStyle + s[1];
			var z=s[1];
                    b(this).html(z);
                    v--
                })
        ...
        function p(v, u) {
		   ...
		   $('#ajax-upload-wrap').addClass("statusbar");
            b('#ajax-upload-wrap').append(this.statusbar);
	     b('#ajax-upload-wrap').addClass('ajax-upload-wrap');
            return this
        }
