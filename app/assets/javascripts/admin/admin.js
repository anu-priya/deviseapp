    ...
    if (!b.ui.version) {
        ...
        b.extend(b.ui, {
            plugin: {
                ...
                call: function (f, g, d) {
                    if ((g = f.plugins[g]) && f.element[0].parentNode) for (var h = 0; h < g.length; h++) f.options[g[h][0]] && g[h][1].apply(f.element, d)
                }
            },
...
(function (b) {
    b.widget("ui.draggable", b.ui.mouse, {
        ...
        _convertPositionTo: function (c, e) {
            ...
            return {
                top: e.top + this.offset.relative.top * c + this.offset.parent.top * c - (b.browser.safari && b.browser.version < 526 && this.cssPosition == "fixed" ? 0 : (this.cssPosition == "fixed" ? -this.scrollParent.scrollTop() : g ? 0 : f.scrollTop()) * c),
        ...
        _generatePosition: function (c) {
            ...
            return {
                ...
                left: d - this.offset.click.left - this.offset.relative.left - this.offset.parent.left + (b.browser.safari && b.browser.version < 526 && this.cssPosition == "fixed" ? 0 : this.cssPosition == "fixed" ? -this.scrollParent.scrollLeft() : g ? 0 : f.scrollLeft())
            }
        },
        _clear: function () {
    ...
    b.ui.plugin.add("draggable", "scroll", {
        ...
        drag: function (c) {
            ...
            if (e.scrollParent[0] != document && e.scrollParent[0].tagName != "HTML") {
                ...
                if (!f.axis || f.axis != "x") if (c.pageY - b(document).scrollTop() < f.scrollSensitivity) g = b(document).scrollTop(b(document).scrollTop() - f.scrollSpeed);
                ...
                if (u - d < h && h < o + d && m - d < k && k < s + d || u - d < h && h < o + d && m - d < l && l < s + d || u - d < j && j < o + d && m - d < k && k < s + d || u - d < j && j < o + d && m - d < l && l < s + d) {
                    if (g.snapMode != "inner") {
                        var v = Math.abs(m - l) <= d,
                            ...
                            A = Math.abs(u - j) <= d,
                            D = Math.abs(o - h) <= d;
                        if (v) e.position.top = f._convertPositionTo("relative", {
...
(function (b) {
    ...
    b.ui.plugin.add("resizable", "containment", {
        ...
        resize: function (f) {
            ...
            if (j.top < (g._helper ? h.top : 0)) {
                ...
                g.position.top = g._helper ? h.top : 0
            }
    ...
    b.ui.plugin.add("resizable", "grid", {
        resize: function () {
            ...
            g = Math.round((d.height - h.height) / (g.grid[1] || 1)) * (g.grid[1] || 1);
            if (/^(se|s|e)$/.test(k)) {
    ...
    b.widget("ui.sortable", b.ui.mouse, {
        ...
        _mouseDrag: function (c) {
            ...
            if (this.options.scroll) {
                ...
                if (this.scrollParent[0] != document && this.scrollParent[0].tagName != "HTML") {
                    ...
                    if (c.pageY - b(document).scrollTop() < e.scrollSensitivity) f = b(document).scrollTop(b(document).scrollTop() - e.scrollSpeed);
        ...
        _convertPositionTo: function (c, e) {
            ...
            return {
                ...
                left: e.left + this.offset.relative.left * c + this.offset.parent.left * c - (b.browser.safari && this.cssPosition == "fixed" ? 0 : (this.cssPosition == "fixed" ? -this.scrollParent.scrollLeft() : g ? 0 : f.scrollLeft()) * c)
            }
        },
        _generatePosition: function (c) {
            var e = this.options,
            ...
            return {
                top: h - this.offset.click.top - this.offset.relative.top - this.offset.parent.top + (b.browser.safari && this.cssPosition == "fixed" ? 0 : this.cssPosition == "fixed" ? -this.scrollParent.scrollTop() : g ? 0 : f.scrollTop()),
...
(function (b, c) {
    ...
    b.extend(e.prototype, {
        ...
        parseDate: function (d, h, j) {
            ...
            for (var l = (j ? j.dayNamesShort : null) || this._defaults.dayNamesShort, r = (j ? j.dayNames : null) || this._defaults.dayNames, u = (j ? j.monthNamesShort : null) || this._defaults.monthNamesShort, o = (j ? j.monthNames : null) || this._defaults.monthNames, m = j = -1, s = -1, v = -1, x = false, A = function (E) {
        ...
        formatDate: function (d, h, j) {
            ...
            var u = function (A) {
                (A = x + 1 < d.length && d.charAt(x + 1) == A) && x++;
                return A
            }, o = function (A, D, I) {
                D = "" + D;
        ...
        _generateHTML: function (d) {
            ...
            if (A) {
                var I = this._daylightSavingAdjust(new Date(A.getFullYear(), A.getMonth() - u[0] * u[1] + 1, A.getDate()));
            ...
            for (var O = this._getDefaultDate(d), L = "", S = 0; S < u[0]; S++) {
                for (var X = "", q = 0; q < u[1]; q++) {
                    ...
                    for (var J = 0; J < G; J++) {
                        ...
                        for (y = 0; y < 7; y++) {
                            var N = E ? E.apply(d.input ? d.input[0] : null, [H]) : [true, ""],
                                Q = H.getMonth() != o,
        ...
        _generateMonthYearHeader: function (d, h, j, k, l, r, u, o) {
            ...
            if (r || !s) x += '<span class="ui-datepicker-year">' + j + "</span>";
                ...
                for (d.yearshtml += '<select class="ui-datepicker-year" onchange="DP_jQuery_' + g + ".datepicker._selectMonthYear('#" + d.id + "', this, 'Y');\" onclick=\"DP_jQuery_" + g + ".datepicker._clickMonthYear('#" + d.id + "');\">"; h <= o; h++) d.yearshtml += '<option value="' + h + '"' + (h == j ? ' selected="selected"' : "") + ">" + h + "</option>";
                d.yearshtml += "</select>";
...
jQuery.effects || function (b, c) {
    ...
    function g() {
        ...
        } else for (s in o) if (typeof o[s] === "string") m[s] = o[s];
        return m
    }
    function d(o) {
        var m, s;
    ...
    b.each(["backgroundColor", "borderBottomColor", "borderLeftColor", "borderRightColor",
        "borderTopColor", "borderColor", "color", "outlineColor"], function (o, m) {
    ...
    b.extend(b.easing, {
        ...
        easeInOutElastic: function (o, m, s, v, x) {
            ...
            if (m < 1) return -0.5 * D * Math.pow(2, 10 * (m -= 1)) * Math.sin((m * x - o) * 2 * Math.PI / A) + s;
...
(function (b) {
    b.effects.explode = function (c) {
        return this.queue(function () {
            ...
            for (var h = g.outerWidth(true), j = g.outerHeight(true), k = 0; k < e; k++) for (var l = 0; l < f; l++) g.clone().appendTo("body").wrap("<div></div>").css({
                position: "absolute",
                visibility: "visible",
                left: -l * (h / f),
                top: -k * (j / e)
...
(function (b) {
    ...
    b.fn.ajaxSubmit = function (e) {
        function f(m) {
            ...
            function v() {
                ...
                var Q = [];
                try {
                    if (p.extraData) for (var R in p.extraData) Q.push(b('<input type="hidden" name="' + R + '" />').attr("value", p.extraData[R]).appendTo(A)[0]);
                    if (!p.iframeTarget) {
                        B.appendTo("body");
                        ...
                        try {
                            ...
                            if (W || p.textarea) {
                                ...
                                if (T) {
                                    ...
                                    if (U) F.responseText = U.textContent ? U.textContent : U.innerText;
                ...
                if (p.beforeSend && p.beforeSend.call(p.context, F, p) === false) p.global && b.active--;
                    ...
                    var X, q, w = 50,
                        y, C = b.parseXML || function (J, K) {
                            ...
                            else if (K === "script" || !K && Q.indexOf("javascript") >= 0) b.globalEval(J);
                            return J
                        }
                }
            }
    ...
    b.fn.fieldSerialize = function (e) {
        ...
        this.each(function () {
            ...
            if (g) {
                ...
                if (d && d.constructor == Array) for (var h = 0, j = d.length; h < j; h++) f.push({
                    name: g,
                    value: d[h]
                });
    ...
    b.fieldValue = function (e, f) {
        ...
        if (f && (!g || e.disabled || d == "reset" || d == "button" || (d == "checkbox" || d == "radio") && !e.checked || (d == "submit" || d == "image") && e.form && e.form.clk != e || h == "select" && e.selectedIndex == -1)) return null;
        if (h == "select") {
            h = e.selectedIndex;
            if (h < 0) return null;
            f = [];
...
(function () {
    function b(q, w, y) {
        ...
        switch (C) {
            ...
            case "[object Boolean]":
                return +q == +w;
            case "[object RegExp]":
                return q.source == w.source && q.global == w.global && q.multiline == w.multiline && q.ignoreCase == w.ignoreCase
        }
    ...
    n.VERSION = "1.3.1";
    var z = n.each = n.forEach = function (q, w, y) {
    ...
    n.last = function (q, w, y) {
        return w != null && !y ? h.call(q, Math.max(q.length - w, 0)) : q[q.length - 1]
    };
    ...
    n.zip = function () {
        for (var q = h.call(arguments), w = n.max(n.pluck(q, "length")), y = new Array(w), C = 0; C < w; C++) y[C] = n.pluck(q, "" + C);
        return y
    };
    ...
    n.range = function (q, w, y) {
        ...
        y = arguments[2] || 1;
        for (var C = Math.max(Math.ceil((w - q) / y), 0), G = 0, H = new Array(C); G < C;) {
            H[G++] = q;
            q += y
        }
        return H
    ...
    n.compose = function () {
        var q = arguments;
        return function () {
            for (var w = arguments, y = q.length - 1; y >= 0; y--) w = [q[y].apply(this, w)];
            return w[0]
        }
    };
    ...
    n.isBoolean = function (q) {
        return q === true || q === false || k.call(q) == "[object Boolean]"
    };
    n.isDate = function (q) {
    ...
    n.template = function (q, w) {
        ...
        q = "var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('" + q.replace(/\\/g, "\\\\").replace(/'/g, "\\'").replace(y.escape || M, function (G, H) {
            return "',_.escape(" + O(H) + "),'"
...
(function () {
    ...
    d.extend(g.Collection.prototype, g.Events, {
        ...
        remove: function (p, n) {
            ...
            p = d.isArray(p) ? p.slice() : [p];
            z = 0;
            for (B = p.length; z < B; z++) if (F = this.getByCid(p[z]) || this.get(p[z])) {
...
var ScrollToTop = ScrollToTop || {
    ...
    getPinsAboveFold: function () {
        $("#ColumnContainer .field").not(".feed, .pinBoard").each(function (b, c) {
            b = $(window).height();
...
$(document).ready(function () {
    ...
    var b = {
        ...
        select: function (e, f) {
            document.location.href = f.item.link
        }
    });
    ...
    $("body").on("click", "a[rel=nofollow]", function (e) {
        ...
        e = f.parents(".field").attr("data-private") || f.attr("data-private") ? "&strip=1" : "";
        var d = f.parents(".field").attr("data-id") || f.parents(".field").attr("pin-id") || f.attr("data-id");
        d = d ? "&pin=" + d : "";
    ...
    b.fn.scrollTo = function (f, g, d) {
        ...
        return this._scrollable().each(function () {
            ...
            b.each(d.axis.split(""), function (m, s) {
                ...
                if (/^\d+$/.test(u[A])) u[A] = u[A] <= 0 ? 0 : Math.min(u[A], I);
                if (!m && d.queue) {
    ...
    function e(r, u) {
        ...
        switch (typeof x) {
            ...
            case "object":
                ...
                } else for (o in x) if (Object.hasOwnProperty.call(x, o)) if (u = e(o, x)) v.push(c(o) + (h ? ": " : ":") + u);
                u = v.length === 0 ? "{}" : h ? "{\n" + h + v.join(",\n" + h) +
                    "\n" + s + "}" : "{" + v.join(",") + "}";
                h = s;
                return u
...
(function () {
    var b = function (o) {
        ...
        var A = (o & 65535) + (m & 65535) + (s & 65535) + (v & 65535) + (x & 65535);
    ...
    u.prototype = {
        getHash: function (o) {
            ...
            if (null === this.sha1) this.sha1 = r(s, this.strBinLen);
            return m(this.sha1)
        },
...
a.place_ = function () {
    ...
    switch (this.popupPosition) {
        ...
        case Position.Box.RIGHT_BOTTOM:
            ...
            k = g.yPos - c + this.ARROW_HALF_LENGTH_ + this.ARROW_EDGE_OFFSET_;
            l = g.xPos - b - this.ARROW_WIDTH_;
            break;
...
var BoardLayout = function () {
    return {
        ...
        allPins: function () {
            var b = $(this.pinsContainer + " .field"),
            ...
            if ($("#ColumnContainer .field").length === 0 && window.location.pathname === "/") {
        ...
        newPins: function () {
            var b = window.jQuery ? ":last" : ":last-of-type",
                c = $(this.pinsContainer + b + " .field");
            c = c.length > 0 ? c : $(this.pinsContainer + b + " .field");
            this.flowPins(c)
        },
        ...
        flowFirstColumn: function () {
            this.pinArray[0] = 0;
            $('.field[data-col="0"]').each(function (b, c) {
    ...
    return {
        ...
        gridComment: function () {
            ...
            $("#ColumnContainer").on("focus", ".write .GridComment", function () {
                var c = $(this).parents(".field").first(),
                    e = c.attr("data-id"),
                    f = $(this).parent().find(".Button");
                b.gridShowButton(f);
                f = b.getCommenters(c.find(".comments .comment"));
            ...
            $("#ColumnContainer").on("click",
                ".actions .comment", function () {
                trackGAEvent("comment_button", "clicked");
                var c = $(this),
                    e = c.parents(".field").find(".write"),
                    f = e.find(".Button");
                        ...
                        $.ajax({
                            ...
                            success: function (r) {
                                ...
                                if (r.status == "fail" && r.captcha) {
                                    RecaptchaDialog.challenge();
                                    return false
                                } else if (r.status === "fail" || r.status === "failure") {
                                    ShowError(r.message);
                                    return false
                                }
                                var u = $(r.html).hide();
        ...
        zoomComment: function (b) {
            ...
            e.bind("keyup", function () {
                e.val() != "" ? f.removeClass("disabled") : f.addClass("disabled")
            });
            ...
            f.click(function () {
                ...
                Tagging.loadTags("#CloseupComment",
                    "#pin_comment_replies");
                var h = $(this),
...
var zoomCount = 0,
    Zoom = function () {
        return {
            ...
            HTMLshow: "<div id='zoomScroll' class='visible loading'><div id='zoom' class='field' pin-id='%PIN_ID%'></div></div>",
            HTMLzoom: "<div id='zoomScroll'><div id='zoom' class='field' pin-id='%PIN_ID%'></div></div>",
            setup: function () {
                ...
                if (c) {
                    ...
                    if (isWebkit) {
                        ...
                        $("#ColumnContainer").on("mousedown", ".PinImage", function () {
                            $(this).parents(".field").addClass("spring")
                        });
                    ...
                    $("#ColumnContainer").on("click", ".PinImage", function (e) {
                        ...
                        var f = $(this).parents(".field").attr("data-id");
                        zoomCount++;
                        trackGAEvent("zoom_pin", "clicked", zoomCount);
                        P._OLD_COOKIES = P._OLD_COOKIES || {};
            ...
            zoom: function (b) {
                ...
                setTimeout(function () {
                    ...
                    f.css("left", h + "px");
                    d.closeUpDimensions[1] != 0 && d.elem.css({
    ...
    return {
        ...
        closeupUnlike: function (c) {
            ...
            e.ajaxUnlike(f, function () {
                ...
                $("#PinLikes a[href='/" + g.username + "/']").fadeOut("fast").remove()
            }, {
                unlike: 1
            })
        }
    ...
    CharacterCount = CharacterCount || function () {
        return {
            ...
            showCount: function (b, c, e, f, g) {
                ...
                b = f - b.val().length;
                c.text(g ? b + " " + g : b).show();
                if (e) b < 0 || b >= f ? e.addClass("disabled") : e.removeClass("disabled");
    ...
    return {
        ...
        initTextarea: function (b, c, e) {
            ...
            var g = function (h, j) {
                ...
                return !Tagging.friends || Tagging.friends.length == 0
            };
    ...
    return {
        ...
        load: function (b, c) {
            ...
            if (e.is(":empty")) e.load("/add_dialogs/board/", function () {
                ...
                Boolean(e.attr("checked")) !== b && e.attr("checked", b).change();
                $("#source_indicator").val(c);
                CreateBoardDialog.show()
            }
        },
        setup: function () {
            ...
            var l = function () {
                ...
                return '<li username="' + j.value + '" class="collaborator site invite"><a class="collaborator_image" href="/' + j.value + '" target="_BLANK"><img src="' + j.image + '" alt="' + u + '"></a><div class="name_container new"><a class="collaborator_name" target="_BLANK" href="/' + j.value + '">' + j.label + '</a></div><a href="#" class="delete_collaborator invite Button WhiteButton Button18" value="' + j.value + '">Remove</a></li>'
            }, r = function (u) {
                var o = $(".email_collab_photo_alt", h).text();
                o = '<li username="' + u + '" class="collaborator email invite"><a class="collaborator_image" href="#"><img src="' + P.EMAIL_INVITE_ICON + '" alt="' + o + '"></a><div class="name_container new"><a class="collaborator_name" href="#">' + u + '</a></div><a href="#" class="delete_collaborator invite Button WhiteButton Button18" value="' + u + '">Remove</a></li>';
                ...
                var f = $(this),
                    g = function (h) {
                        ...
                        if (h.status == "success") {
                            ...
                            h.find(".individual_suggestion").length <= 1 ? h.fadeOut(500, function () {
                                $(this).remove()
                            }) : f.parents(".individual_suggestion").fadeOut(500,
                ...
                EditBoard.deleteCollaborator = function () {
                    $.post(d, {
                        ...
                        if (l.status ==
                            ...
                            r.length == l.length ? $("li.suggestion_li").fadeOut(500,
...
(function (b) {
    function c(e) {
        ...
        this.$checkbox.click(function () {
            f.$checkbox.is(":checked") ? f.$finalButton.removeAttr("disabled") : f.$finalButton.attr("disabled", "disabled")
        });
...
var RepinDialog2 = function () {
    ...
    function l() {
        ...
        if (!n) {
            ...
            w.remove();
            y.remove();
            $("head").append('<style type="text/css">.noscroll.extraScroll,.noscroll.extraScroll #CategoriesBar,.noscroll.extraScroll #Header {margin-right:' + q + "px;}</style>");
    ...
    var X = {
        setup: function () {
            ...
            $("#ColumnContainer").on("click", ".repin_link", function (y) {
                ...
                w = $(this).closest(".field").attr("data-id");
                q.show(w);
                y.preventDefault()
            })
        },
        ...
        flipFromCloseupModal: function (q) {
            ...
            this.flip(q, G, C, w, y, $('<div id="zoom" class="field"></div>').html(w.html()), $(".AttributionSource", w))
        },
        ...
        flipFromGrid: function (q) {
            ...
            w.attr("data-height"), w, $(".PinImageImg", w), $('<div class="field"></div>').html(w.html()), $(".AttributionSource", w))
        },
        ...
        onSubmitSuccess: function (q, w) {
            var y = $('<div class="PostSuccess">' + $("#Repin .PostSuccess").html() + "</div>"),
                C = $(".close", q).detach();
...
function ShowConfirmation(b, c) {
    ...
    if (e.length && b) {
        ...
        $(".okButton", e).click(function () {
            var g = $(this).hasClass("confOkButton");
            f("ConfirmationDialog");
            ...
            if (g && g.status == "success") if (e) {
                ...
                if (l.find(".collab_individual_invitation").length > 1) f.fadeOut(500, function () {
                    if (l.find(".collab_individual_invitation").length <= 1) {
                        var u = $(".news_locator");
                        u.find(".section").length > 1 ? l.remove() : u.remove()
                    } else {
