...
(function (b) {
    ...
    b.fn.uploadFile = function (r) {
            ...
            if (b.fn.ajaxForm) {
                if (q.dragDrop) {
                    var s = b('<div class="ajax-upload-dragdrop" style="vertical-align:top;"></div>');
                      var qq = b('<div id="ajax-upload-wrap_'+extrsct_ids+'" style="vertical-align:top;"></div>');
                    b(l).before(s);
                    if($('#ajax-upload-wrap_fileuploader').length==0){
                      b(l).before(qq);
                    }
                    b(s).append(e);
        ...
        function p(x, A, C, t) {
            ...
            var u = "<input  class='file_uploder' type='file' id='" + z + "' name='" + C.fileName + "'/>";
            if (C.multiple) {
                if (C.fileName.indexOf("[]") != C.fileName.length - 2) {
                    C.fileName += "[]"
                }
                u = "<input class='file_uploder' type='file' id='" + z + "' name='" + C.fileName + "' multiple/>"
            }
        ...
        function o(u, t) {
            ...
            $("#ajax-upload-wrap_"+extrsct_id).addClass("statusbar");
            b("#ajax-upload-wrap_"+extrsct_id).append(this.statusbar);
	     b("#ajax-upload-wrap_"+extrsct_id).addClass('ajax-upload-wrap');
            return this
        }
        ...
        function m(y, x, t, v, z) {
                ...
                var ss=z["selector"];
             var extrsct_ss=strs.replace("#","");
             if(extrsct_ss=="fileuploader"){
                 $('.uploding').hide();
                   $('.uplodad_photos').show();
             }
             if(extrsct_ss=="fileuploader_document"){
               $('.uploding_documents').hide();
                $('.uplodad_docs').show();
             }
            ...
            var u = {
                ...
                success: function (A, s, B) {
                    ...
                    if (x.showStatusAfterSuccess) {
                        if (x.showDone) {
                           t.progressbar.css("display", "none");
                           t.progressDiv.css("display","none");
