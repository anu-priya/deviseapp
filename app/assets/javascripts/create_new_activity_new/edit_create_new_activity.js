...
/*****************************************
		Whole Day
 *****************************************/
function dispCheckDays(cname,id,incId,db){
     //  alert(21);
...
/*****************************************
		Price Div Func
 ******************************************/
function dispCheckPrice(cname,id,g){ 
  
  
    $("#any_advance_early_net_price_error").hide();
    ...
    if((billing_type_sc=='1')||(billing_type_sc=='4'))
    {
        if(id==1){
            ...
            if(g!=0){
                $("#net_database").val( '0');
                var r=confirm("Do you want change the price");
                if (r==true)
		    
                {
                    ...
                    if(myChoose_schedule.length>1)// if more than one div and less thhan schedule
                    {
        ...
        if(id==1){
	        $("#net_price_anytime").css("display","block");
            $("#netPriceDiv1").show();
            ...
            $("#net_price_anytime").css("display","none");
            $("#advancedPriceDiv1").hide();
            $("#netPriceDiv1").hide();
            $('.priceDiv').css('height','200px');
            $(".ddEligble").hide();
...
/***************************************
		Age DropDown
 ****************************************/
function setAgeDropDownValue(type1,type2,age){
    if(age=="All" || age=="Adults"){
        if(type1=="min"){
            //document.getElementById("age1").value=type2;
            //document.getElementById("age2").value=type2;
...
function scheduleDropDown(val){
    ...
    if(val == "Schedule"){
        ...
        mySchedule[0] ="1";
        var w_day= $('#whole_day_tabs').val();
        w_day=w_day.split(',');
        for(u=0;u<w_day.length;u++){
            //$ ('#outer_whole_day_'+w_day[u]).remove();
            delete_whole_day_block(w_day[u]);
        }
        add_whole_day_block(0,"single");
		
        $('.radio_selected_price').css('display','none');
        $('.radio_normal_price').css('display','inline-block');
        $('#radio_selected_price_1').css('display','inline-block');  
        $('#radio_normal_price_1').css('display','none');
        $('#price_1').val(1);
        ...
        $('#continue_click').val('1');// once continue clicked set the flag 1
	
        form_reset_values1();
        myChoose_schedule.length=0;
    //  validate_notes_netprice(0,0);
    //  validate_notes_adprice(0,0);
        ...
        $('#netPriceDiv1').css('display','block');
        $('#advancedPriceDiv1').css('display','none');
        $('#continue_click').val('1');
        // removing schedules
        var s_day= $('#schedule_tabs').val();
        s_day=s_day.split(',');
        for(u=0;u<s_day.length;u++){
			
            delete_schedule(s_day[u]);
        }
        add_schedule(0);
    ...
    //  validate_notes_adprice(0);
        ...
        if(whole_day_tabs.length>1){
            $(".delete_whole_day").css("display","block");
        }
        else{
...
function scheduleDropDown_rails(val){    
    document.getElementById("billing_type").style.color="#444444" ;
    $(".priceDiv").css("margin-top","0px");
    $(".priceDiv .setBlueBG").css("border-top","none");
...
function form_reset_values1(){
    $('#db_advance_price').val('0');
    $('#db_net_price').val('0');
    ...
    $('#changing_schedule_adv_count').val('0');
    $('#edit_schedule_div_net_count').val('');
...
function discTypeChanged1(net,id1,id2,id3,cu_value,lstval){
...
function added_new_schedule1(){
    added_new_schedule12();
    ...
    if(billing_type == "Schedule"){
        ...
        for(var i=0;i<arLen;i++){
            ...
            var continue_click= $('#continue_click').val();// contiue checked or not
            ...
            if((schedules!='' )&&(net_count=='0'))
            {
                ...
                if($('#db_net_price').val()!=1){
                    validate_notes_netprice(0);
                }
                $('.kk').remove();
                schedules_adv=yt.split("</br>");
                ...
                $('.bb').remove();
                $('#netPriceDiv select.choose_schedule').html('');
                $('#netPriceDiv select.choose_schedule').append('<option  value="">--Choose--</option>');
                for(f=0;f<schedules_adv.length-1;f++)
                {
                 
				   
                    var sd=schedules_adv[f].split('_');
				     
                    $('#netPriceDiv select.choose_schedule').append('<option class="bb" name="'+(i+1)+'" id="'+(i+1)+'" value="' + schedules_adv[f] + '">a' + sd[0]+ '</option>');
                ...
                if((arLen>(scd.length-1))&&(i==(arLen-1)))
                {
                    ...
                    //         $('#netPriceDiv select.choose_schedule').append('<option  class="bb" name="'+(i+'yu')+'" id="'+(i+11)+'" value="' + formate + '">' + formate1+ '</option>');
            ...
            {	//////alert('122');
                ...
                //////alert(ides);
                if(ides==-1)	{
                    $('#netPriceDiv select.choose_schedule').append('<option class="bb" name="'+(i+'yu')+'" id="'+(i+11)+'" value="' + formate + '">b' + formate1+ '</option>');
                    schedules1=$('#changing_schedule_net').val();
                    var res = formate.replace("</br>","");
                    schedules1+=res;
                    $('#changing_schedule_net').val(schedules1);
            ...
            else if(net_count!='0')
            {
                ...
                {//////alert('else if if');
                    $('#netPriceDiv select.choose_schedule').append('<option class="bb" name="'+(i+1)+'" id="'+(i+1)+'" value="' + formate + '">c' + formate1+ '</option>');
                    ...
                    {//////alert(f+"_kg");
                        ...
                        {
                            //////alert(f);
                            $('#netPriceDiv select.choose_schedule').append('<option  class="bb"name="'+(i+1)+'" id="'+(i+1)+'" value="' + formate + '">d' + formate1+ '</option>');
                    ...
                    if((arLen>(scd.length-1))&&(i==(arLen-1))){
                        ...
                        //////alert('it');
                        $('#netPriceDiv select.choose_schedule').append('<option class="bb" name="'+(i+1)+'" id="'+(i+1)+'" value="' + formate + '">e' + formate1+ '</option>');
                        schedules1=$('#changing_schedule_net').val();
                        schedules1+='</br>'+result_1;
            ...
            else if((edit_form=='edit')&&(continue_click!=1))
            {
                ...
                myCars5.slice(0,-1);
                myCars5=myCars5.split(',');
                var ides=myCars5.indexOf(popId);
                var rest = formate.replace("</br>","");
						  
                var schedule_net=$('#changing_schedule_net').val();
						   
                schedule_net= schedule_net.split('</br>');
						   
                var idet=schedule_net.indexOf(rest);
                ...
                if(ides==-1)					// if  a new schedule adding after saving.
                {
                    ...
                    //  $('#netPriceDiv select.choose_schedule').html('');
                    //$('#netPriceDiv select.choose_schedule').html('<option name="test" value="test">Test</option>');
                    $('#netPriceDiv select.choose_schedule').append('<option  class="bb"name="'+(i+1)+'" id="'+(i+1)+'" value="' + formate + '">f' + formate1+ '</option>');
                    ...
                    {//////alert(f+"_kg");
                        ...
                        {
                            //////alert(f+'a');
                            $('#netPriceDiv select.choose_schedule').append('<option  class="bb" name="'+(i+1)+'" id="'+(popId)+'" value="' + formate + '">g' + formate1+ '</option>');
                        }
                    }
                    // if a new option is added (schedule added )     and same for others
                    if((arLen>(scd.length))&&(i==(arLen))){
										  
                        //   ////alert('it');
                        var res = formate.replace("</br>","");
                        result_1=res;
                        $('#netPriceDiv select.choose_schedule').append('<option  class="bb"name="'+(i+1)+'" id="'+(popId)+'" value="' + formate + '">h' + formate1+ '</option>');
                        schedules1=$('#changing_schedule_net').val();
                        schedules1+='</br>'+result_1;
                        ...
                        $('.kk').remove();
                        t_schednet1+=formate+'+';
                        t_schednet11=t_schednet1.split('+');

							
                        for(l=0;l<t_schednet11.length-1;l++) {
                            splits=t_schednet11[l].split('_');
                            $('#netPriceDiv select.choose_schedule').append('<option class="kk" name="'+(i+1)+'" id="'+(i+1)+'" value="' + t_schednet11[l] + '">t' + splits[0]+ '</option>');
                        }
						
                    // $('#netPriceDiv select.choose_schedule').append('<option   name="'+(i+1)+'" id="'+(popId)+'" value="' + formate + '">C' + formate1+ '</option>');
                    //	$('#netPriceDiv select.choose_schedule').remove();
                    // $('#netPriceDiv #choose_schedule_net_'+popId+'_1').css('display','none');
                    }
                ...
                t_sched+=formate+'+';
                t_schedl=t_sched.split('+');
				
                $('.kk').remove();
                for(l=0;l<t_schedl.length-1;l++) {
                    splits=t_schedl[l].split('_');
                    $('#netPriceDiv select.choose_schedule').append('<option class="kk" name="'+(i+1)+'" id="'+(i+1)+'" value="' + t_schedl[l] + '">n' + splits[0]+ '</option>');
                }
            }
            ...
            { 
                ...
                $('#advancedPriceDiv select.choose_schedule').html('');
                $('#advancedPriceDiv select.choose_schedule').append('<option  value="">--Choose--</option>');
				
				
                $("#advancedPriceDiv select.choose_schedule .aa").remove();
                for(f=0;f<schedules_adv.length-1;f++)
                {
                    ...
                    $('#advancedPriceDiv select.choose_schedule').append('<option class="aa" name="'+(f+1)+'" id="'+(f+1)+'" value="' + schedules_adv[f] + '">' + sd[0]+ '</option>');
                    ...
                    {
                //$('.bb').remove();
                //   $('#advancedPriceDiv select.choose_schedule').append('<option class="bb" name="'+(i+1)+'" id="'+(i+1)+'" value="' + formate + '">a' + formate1+ '</option>');
                }
                }
				
                if((arLen>(scd.length-1))&&(i==(arLen-1))){
								
                    // $('#advancedPriceDiv select.choose_schedule').append('<option class="bb" name="'+(i+1)+'" id="'+(i+1)+'" value="' + formate + '">b' + formate1+ '</option>');
            ...
            else if(($('#changing_schedule_decide_adv').val()=='1')&&(schedules=='' ))
            {
                ...
                //////alert(ides);
                if(ides==-1)	{
                    $('#advancedPriceDiv select.choose_schedule').append('<option class="ka" name="'+(i+'yu')+'" id="'+(i+11)+'" value="' + formate + '">' + formate1+ '</option>');
            ...
            else if(adv_count!='0')
            {
                ...
                if(ides==-1)					// if  a new schedule adding after saving.
                {//////alert('else if if');
                    $('#advancedPriceDiv select.choose_schedule').append('<option class="ka" name="'+(i+1)+'" id="'+(i+1)+'" value="' + formate + '">' + formate1+ '</option>');
            ...
            else if((edit_form=='edit')&&(continue_click!=1))
            {
                ...
                var schedule_net=$('#changing_schedule_adv').val();
                ...
                if(ides==-1)					// if  a new schedule adding after saving.
                {
                    ...
                    //  $('#netPriceDiv select.choose_schedule').html('');
                    //$('#netPriceDiv select.choose_schedule').html('<option name="test" value="test">Test</option>');
                    $('#advancedPriceDiv select.choose_schedule').append('<option class="aa" name="'+(i+1)+'" id="'+(i+1)+'" value="' + formate + '">t' + formate1+ '</option>');
							     
                    var Schedules1=$('#changing_schedule_adv').val();
                    ...
                    $('#changing_schedule_adv').val(Schedules1);
                }
                else{
                    //     ////alert('else if else');// else checking the old schedule after saveing
                    ...
                    if(schedules_adv!=''){
                        ...
                        schedules_adv=schedules_adv;
                    }
                    //////alert(schedules);
                    if(schedules_adv.length>1){
                        $('.add_ad_schedule ').last().css("display","block");//for display add button and same for others
                    }
                    // checking the options are already added and same for others
                    for(f=0;f<schedules_adv.length;f++)
                    {//////alert(f+"_kg");
                        ...
                        result_1=res;
                        res=res.split('_');
                        schedules_split=schedules_adv[f].split('_');
                        if(res[1]!=schedules_split[1])
                        {
                            //////alert(f+'a');
                            $('#advancedPriceDiv select.choose_schedule').append('<option class="ka" name="'+(i+1)+'" id="'+(popId)+'" value="' + formate + '">' + formate1+ '</option>');
                        }
                    }
                    // if a new option is added (schedule added )     and same for others
                    if((arLen>(scd.length))&&(i==(arLen))){
                        ...
                        result_1=res;
                        $('#advancedPriceDiv select.choose_schedule').append('<option class="ka"  name="'+(i+1)+'" id="'+(popId)+'" value="' + formate + '">' + formate1+ '</option>');
                        schedules1=$('#changing_schedule_adv').val();
                        schedules1+='</br>'+result_1;
                        ...
                        $('.ka').remove();
                        t_schedadv1+=formate+'+';
                        t_schedadv11=t_schedadv1.split('+');
				
				
                        for(l=0;l<t_schedadv11.length-1;l++) {
                            splits=t_schedadv11[l].split('_');
                            $('#advancedPriceDiv select.choose_schedule').append('<option class="ka" name="'+(i+1)+'" id="'+(i+1)+'" value="' + t_schedadv11[l] + '">' + splits[0]+ '</option>');
                        }
				
                    // $('#advancedPriceDiv select.choose_schedule').append('<option class="kk"   name="'+(i+1)+'" id="'+(popId)+'" value="' + formate + '">C' + formate1+ '</option>');
                    //	$('#netPriceDiv select.choose_schedule').remove();
                    //      $('#advancedPriceDiv #choose_schedule_'+popId+'_1').css('display','none');
                    }
                }
                ...
                t_schedadv+=formate+'+';
                t_schedadv1=t_schedadv.split('+');
                $('.ka').remove();
                $('#changing_schedule_adv').val(t_schedadv1);
                for(l=0;l<t_schedadv1.length-1;l++) {
                    splits=t_schedadv1[l].split('_');
				
                    $('#advancedPriceDiv select.choose_schedule').append('<option class="ka" name="'+(i+1)+'" id="'+(i+1)+'" value="' + t_schedadv1[l] + '">' + splits[0]+ '</option>');
                }
        ...
        for(a=0;a<arLen;a++)
        {
            ...
            if((schedules!='' )&&(net_count=='0'))
            {
                ...
                for(f=0;f<schedules_adv.length-1;f++)
                {
                    ...
                    $('#netPriceDiv select.choose_schedule').append('<option class="bb" name="'+(i+1)+'" id="'+(i+1)+'" value="' + schedules_adv[f] + '">' + sd[0]+ '</option>');
            ...
            else if(net_count!='0')
            {
                ...
                if(ides==-1)					// if  a new schedule adding after saving.
                {
                    $('#netPriceDiv select.choose_schedule').append('<option class="bb" name="'+(i+1)+'" id="'+(i+1)+'" value="' + formate + '">' + formate1+ '</option>');
                    var Schedules1=$('#changing_schedule_net').val();
                    if(Schedules1=='')
                    {
                        Schedules1=formate1;
            ...
            else if((edit_form=='edit')&&(continue_click!=1))
            {
                ...
                if(ides==-1)					// if  a new schedule adding after saving.
                {
                    ...
                    {//////alert(f+"_kg");
                        ...
                        {
                            //////alert(f+'a');
                            $('#netPriceDiv select.choose_schedule').append('<option  name="'+(i+1)+'" id="'+(popId)+'" value="' + formate + '">' + formate1+ '</option>');
                        }
                    }
                    // if a new option is added (schedule added )     and same for others
                    if((arLen>(scd.length))&&(i==(arLen))){
                        ...
                        $('.kk').remove();
                        t_schednet11+=formate+'+';
                        t_schednet111=t_schednet11.split('+');
									
									
                        for(l=0;l<t_schednet111.length-1;l++) {
                            splits=t_schednet111[l].split('_');
                            $('#netPriceDiv select.choose_schedule').append('<option class="kk" name="'+(i+1)+'" id="'+(i+1)+'" value="' + t_schednet111[l] + '">' + splits[0]+ '</option>');
                        }
                ...
                whole_net+=formate+'+';
                whole_net1=whole_net.split('+');
				
                $('.kk').remove();
                for(l=0;l<whole_net1.length-1;l++) {
                    splits1=whole_net1[l].split('_');
                    $('#netPriceDiv select.choose_schedule').append('<option class="kk" name="'+(i+1)+'" id="'+(i+1)+'" value="' + whole_net1[l] + '">' + splits1[0]+ '</option>');
                }
            ...
            if((schedules_adv!='' )&&(adv_count=='0'))
            {
                ...
                for(f=0;f<schedules_adv.length-1;f++)
                {
                    ...
                    $('#advancedPriceDiv select.choose_schedule').append('<option class="aa" name="'+(i+1)+'" id="'+(i+1)+'" value="' + schedules_adv[f] + '">' + sd[0]+ '</option>');
                ...
                if((arLen>(scd.length-1))&&(i==(arLen-1))){
                    ...
                    $('#advancedPriceDiv select.choose_schedule').append('<option class="aa" name="'+(i+1)+'" id="'+(i+1)+'" value="' + formate + '">' + formate1+ '</option>');
                    schedules12=$('#changing_schedule_adv').val();
                    schedules12+='</br>'+result_11;
                    $('#changing_schedule_adv').val(schedules12);
                }
            ...
            else if(($('#changing_schedule_decide_adv').val()=='1')&&(schedules=='' ))
            {
                ...
                //////alert(ides);
                if(ides==-1)	{
                    $('#advancedPriceDiv select.choose_schedule').append('<option class="aa" name="'+(i+'yu')+'" id="'+(i+11)+'" value="' + formate + '">' + formate1+ '</option>');
                    schedules111=$('#changing_schedule_adv').val();
                    var res = formate.replace("</br>","");
                    schedules111+=res;
                    $('#changing_schedule_adv').val(schedules111);
            ...
            else if((edit_form=='edit')&&(continue_click!=1))
            {
                ...
                if(ides==-1)					// if  a new schedule adding after saving.
                {
                    ...
                    if((arLen>(scd.length))&&(i==(arLen))){
                        ...
                        //  $('.kk').remove();
                        t_schedadv11+=formate+'+';
                        t_schedadv101=t_schedadv11.split('+');
				
				
                        for(l=0;l<t_schedadv101.length-1;l++) {
                            splits=t_schedadv101[l].split('_');
                            $('#advancedPriceDiv select.choose_schedule').append('<option class="ka" name="'+(i+1)+'" id="'+(i+1)+'" value="' + t_schedadv101[l] + '">' + splits[0]+ '</option>');
                        }
			  
                    //  $('#advancedPriceDiv select.choose_schedule').append('<option class="kn"  name="'+(i+1)+'" id="'+(popId)+'" value="' + formate + '">C' + formate1+ '</option>');
                    //	$('#netPriceDiv select.choose_schedule').remove();
                    //   $('#advancedPriceDiv #choose_schedule_'+popId+'_1').css('display','none');
                    }
                }
                ...
                whole_adv+=formate+'+';
                whole_adv1=whole_adv.split('+');
				
				
                for(l=0;l<whole_adv1.length-1;l++) {
                    splits1=whole_adv1[l].split('_');
                    $('#advancedPriceDiv select.choose_schedule').append('<option class="kk" name="'+(i+1)+'" id="'+(i+1)+'" value="' + whole_adv1[l] + '">' + splits1[0]+ '</option>');
                }
    ...
    if((billing_type_sc=='1')||(billing_type_sc=='4'))
    {
        if (descion=='net')
        {
            ...
            if(yes==1){
                ...
                // ////alert(strSelected12);
                var t_schedules=$('#total_schedule').val();
                var    get_valu=t_schedules.slice(0,-5);
                get_valu=get_valu.split('</br>');
                var total_div_count=$('#total_div_count').val();
                total_div_count=total_div_count.split(',');
                if(get_valu.length==total_div_count.length){// checking for choose all schedule
                ...
                var net_edit=  $('#changing_schedule_net_base').val();
                net_edit=net_edit.split('</br>');
                /***********************************/
	
                to_choose_net_opt=arr_diff(myChoose_schedule,selected_net_option);// get the remaing to choose
                //////alert(to_choose_net_opt) ;
                // ////alert(to_choose_net_opt);
                /**********************************/
                if (to_choose_net_opt.length>0)
        ...
        else if (descion=='adv')
        {
            ...
            if(yes==1){
                ...
                var get_values=$('#changing_schedule_adv').val();//for edit no need to check the 1st value
                ...
                var adv_edit=  $('#changing_schedule_adv_base').val();
                adv_edit=adv_edit.split('</br>');
                /***********************************/
                // ////alert(myChoose_schedule+'myChoose_schedule'); ////alert(selected_adv_option+'selected_adv_option');
                to_choose_adv_opt=arr_diff(myChoose_schedule,selected_adv_option);// get the remaing to choose
                //  ////alert(to_choose_net_opt);
                /**********************************/
                if (to_choose_adv_opt.length>0)
...
function choose_schedule(s,net) {
    ...
    if(net=='net'){
        ...
        selected_net_option.splice(myNetdiv.length-1,1);
        //////alert(selected_net_option.length);
        //strSelected12=strSelected12.split('_');
        selected_net_option.push(strSelected12);
    ...
    /* if(strSelected12=="select all_0"){
        ...
        var strSelected12 = e12.options[e12.selectedIndex].value;
        strSelected12= strSelected12.replace("</br>","");
        //  strSelected12_value=strSelected12.split('_');
        $('#selected_value_'+s).val('');
        $('#selected_value_'+s).val(strSelected12);
		
        selected_adv_option.splice(myAdvdiv.length-1,1);
	
        //strSelected12=strSelected12.split('_');
        selected_adv_option.push(strSelected12);
...
function choose_schedules(s,net,data_base) {
    ...
    if(net=='net'){
        ...
        var strSelected12 = e12.options[e12.selectedIndex].value;
        strSelected12= strSelected12.replace("</br>","");*/
        var strSelected12=$('#selected_net_value_'+s).val();
...
function validate_notes_netprice(s)
{
    ...
    if((s=='0')&&(cont_inue=='0')){
        ...
        for(j=0;j<to_choose_net_opt.length;j++) // adding schedules as options to drop dwon
        {
            ...
            append_sc+='<option value="'+to_choose_net_opt[j]+'">'+to_choose_net_opt[j]+'</option>';
        ...
        if(yes==1){
            ...
            netPriceDiv+='<div class="priceContainer" id="netPriceDiv_'+s+'"><input id="earlybid_decide_'+s+'" type="hidden" value="0" name="earlybid_decide_'+s+'"><input type="hidden" name="last_in_discount_id_'+s+'" id="last_in_discount_id_'+s+'" value="'+s+'_1_0"><input type="hidden" name="last_discount_id_'+s+'_1" id="last_discount_id_'+s+'_1" value="0"><input id="selected_value_'+s+'" type="hidden" value="" name="selected_value_'+s+'"><input type="hidden" name="delete_discount_id_'+s+'_1" id="delete_discount_id_'+s+'_1" value="'+s+'_1_0"><table cellpadding="0" cellspacing="0" border="0"><tr><td><div class="priceOuterDiv" id="net_priceOuterDiv_'+s+'">';
            netPriceDiv+='<table cellpadding="0" cellspacing="0" border="0" id="net_price_div_1_'+s+'"><tr><td id="added_price_'+s+'"><table cellspacing="0" cellpadding="0" border="0"><tr><td><div class="lt  advancedPriceContainer" id="advancedPriceContainer_'+s+'_1" ><div id="chosen_sc_txt_'+s+'_2_0" style="display: none;" class="choosen_head"></div><div class="chosen_op"  id="chosen_sc_txt_'+s+'_1_0" style="display: none;" ></div><div class="priceRow1_top" style="padding-top:0px;"><div class="lt blackText setWidthPrice3">Choose Schedule</div><div class="lt blackText setWidthPrice"> Net Price</div><div class="clear"></div></div>';
            netPriceDiv+='<div class="priceRow1_bottom"> <div class="lt"><select name="choose_schedule_net_'+s+'_1 " onchange="choose_schedule('+s+',\'net\')" id="choose_schedule_net_'+s+'_1" class="drop_down_left width_set7 choose_schedule" style="margin-left: 0px;"><option value="" selected="selected">--Choose--</option></select><input type="text" id="chosen_sc_txt_'+s+'_1_0"  size="30"  readonly="readonly" class="lt textbox1" name="chosen_sc_txt_1_1_4" value="" style="display: none;"><input type="hidden" id="chosen_sc_'+s+'_1" name="chosen_sc_'+s+'_1" value=""><input type="hidden" id="all_sc_'+s+'_1_0" name="all_sc_'+s+'_1_0" value=""/></div><input type="text" id="price_'+s+'_1" name="price_'+s+'_1" class="lt textbox" value="Enter Price" onfocus="focusChangeBorderColor1(\'price_'+s+'_1\')" maxlength="7" onKeyPress="return number(event);" onblur="blurChangeBorderColor1(\'price_'+s+'_1\')" style="width:152px;margin-left: 6px;" />';
...
function edit_netprice_whole_div(s)
{
    ...
    myNetdiv.push(s);
    edit_netPriceDiv+='<div class="priceContainer" id="netPriceDiv_'+s+'"><input id="earlybid_decide_'+s+'" type="hidden" value="0" name="earlybid_decide_'+s+'"><input type="hidden" name="last_discount_id_'+s+'_1" id="last_discount_id_'+s+'_1" value="0"><input id="selected_net_value_'+s+'" type="hidden" value="" name="selected__net_value_'+s+'"><input type="hidden" name="delete_discount_id_'+s+'_1" id="delete_discount_id_'+s+'_1" value="'+s+'_1_0"><input type="hidden" name="last_in_discount_id_'+s+'" id="last_in_discount_id_'+s+'" value="'+s+'_1_0"><table cellpadding="0" cellspacing="0" border="0"><tr><td><div class="priceOuterDiv" id="net_priceOuterDiv_'+s+'">';
    ...
    edit_netPriceDiv+='<div class="staticDiscount_net_1_1"><div class="priceRow2_top"><div class="lt blackText setWidthDiscount">Discount Type and Price</div><div class="lt blackText setWidthDiscount" style="display:none" id="no_sess_net_'+s+'_'+1+'_0">Quantity</div><div class="lt blackText setWidthDiscount" style="display:none" id="no_part_net_'+s+'_1_0"style="width:185px">Discount Amount/Percentage</div><div class="lt blackText setWidthDiscount" style="display:none" id="no_part_net_'+s+'_1_0"style="width:185px">Discount Amount/Percentage</div><div class="clear"></div></div>';
    ...
    edit_netPriceDiv+=' <div id="dynamicNetPrice_'+s+'"></div><div id="staticDiscount_net_'+s+'_1" class="staticDiscount_net_1_1"></div>';
    ///////////////
    ...
    edit_netPriceDiv+='<div class="clear"></div></div></td><td valign="bottom"><div class="lt add_del_icons" id="add_del_icons_1_'+s+'"><div class="delete_schedule_net" id="o_delete_schedule_'+s+'"  style="margin-top:0px;" onclick="delete_net_price('+s+',0)">&nbsp;</div><div  onClick="validate_notes_netprice('+s+')" id="o_add_schedule_'+s+'"  style="margin-top:0px;"class="out_add_schedule">&nbsp;</div></div>';
    edit_netPriceDiv+='<div class="clear"></div></td></tr></table></div> </div><div class="clear"></div>';
    //$("add_schedule_"+s).css("display","block");
    ...
    else  if((myNetdiv.length==1)&&(myChoose_schedule.length==1))			// if only one schedule
    {
...
{
    net='net';
    netPriceDiv_early+='<div class="staticDiscount_net_1_1" id="taticDiscount_net_'+s+'_1_0"><input id="earlybid_decide_'+s+'" type="hidden" value="0" name="earlybid_decide_'+s+'"><div class="priceRow2_top"><div class="lt blackText setWidthDiscount">Discount Type and Price</div><div class="lt blackText setWidthDiscount" style="display:none" id="no_sess_net_'+s+'_'+1+'_0">Quantity</div><div class="lt blackText setWidthDiscount" style="display:none" id="no_part_net_'+s+'_1_0"style="width:185px">Discount Amount/Percentage</div><div class="lt blackText setWidthDiscount" style="display:none" id="no_part_net_'+s+'_1_0"style="width:185px">Discount Amount/Percentage</div><div class="clear"></div></div>';
    netPriceDiv_early+='<div class="clear"></div><div class="priceRow2_bottom"><div class="lt discout_type_net" id="discount_type_net_'+s+'_1_0"><select name="ad_discount_type_net_'+s+'_1_0" id="ad_discount_type_net_'+s+'_1_0" class="drop_down_left width_set6" onchange="discTypeChanged(\'net\','+s+',1,0,this.value,1);$(this).css(\'color\',\'#444444\');" onkeyup="discTypeChanged(\'net\',1,1,this.value)"> <option value="--Choose Discount Type--" selected="selected">--Choose Discount Type--</option><option value="Early Bird Discount">Early Bird Discount</option><option value="Multiple Participant Discount">Multiple Participant Discount</option> </select></div>    ';
    netPriceDiv_early+='<div id="session_net_'+s+'_1_0" style="display:none;"><div id="provider_event_list" style="float: left;width: 25px;"><div id="menu_active" class="lt ActiveDivMenu"><ul><li><img alt="" src="/assets/provider_register/help.png" style="cursor: pointer;"><ul style="width: 275px;" class="sub-menu dispParticipantToll"><li>A discount for those who buy multiple sessions</li></ul></li></ul><div class="clear"></div></div></div>';
...
function add_net_advanced_price(b,q)
{
    ...
    if(yes==1){
        ...
        inner_netPriceDiv+='<div class="staticDiscount_net_1_1" id="staticDiscount_net_'+b+'_'+q+'" ><div class="priceRow2_top"><div class="lt blackText setWidthDiscount">Discount Type and Price</div><div class="lt blackText setWidthDiscount" style="display:none" id="no_sess_net_1_'+b+'_'+q+'">Quantity</div><div class="lt blackText setWidthDiscount" style="display:none" id="no_part_net_1_'+b+'_'+q+'">Quantity</div><div class="clear"></div></div>';
...
function addding_earlybids_divs(netapnd,b,q,h)
{
    ...
    inner_discountDiv+='<div class="priceRow3_top"><div class="lt blackText setWidthSubs">Quantity</div><div class="lt blackText">Valid  Until</div><div class="lt blackText setWidthDiscount" style="display:none" id="noe_part_'+netapnd+''+b+'_'+q+'_'+h+'"style="width:185px">Discount Amount/Percentage</div><div class="clear"></div></div><div class="clear"></div>';
    ...
    if (netapnd == 'net_'){
        ...
        $("#ad_discount_type_"+netapnd+""+b+"_"+q+"_"+h).css("pointer-events"," none");
        $("#ad_discount_type_"+netapnd+""+b+"_"+q+"_"+h).css("cursor"," default");
    }
    else{
    ...
    $( "#ad_valid_date_"+b+"_"+q+"_"+h).datepicker({
        showOn : "button",
        buttonImage : "/assets/create_new_activity/date_icon.png",
        buttonImageOnly : true,
        minDate: 0,
        dateFormat: "D, M d, yy",
        altField : "#ad_valid_date_alt_"+b+"_"+q+"_"+h,
        altFormat : "yy-m-d"
    });
 ...
 **********************************************************/
function validate_notes_adprice1(ad)
{
    var e = document.getElementById('billing_type');
    var strSelected = e.options[e.selectedIndex].value;
    if(strSelected=="Schedule"){
    ...
    if((ad=='0')&&(cont_inue==0)){
        ...
        if(yes==1){
            ...
            if(schedules.length>=1 && strSelectedw!="select all" ){
                ...
                {
                    sc_hed=schedules[k].split('_');
                    append_sc+= '<option class="ka" value="' + schedules[k] + '">' + sc_hed[0] + '</option>';
                }
            ...
            advance_add+='<div class="priceContainer"  id="priceContainerDiv_'+ad+'"><input type="hidden" name="earlybid_decide_adv_'+ad+'_1" id="earlybid_decide_adv_'+ad+'_1" value="0"><input type="hidden" name="delete_ad_discount_id_'+ad+'_1" id="delete_ad_discount_id_'+ad+'_1" value="'+ad+'_1_0"><input type="hidden" name="inner_div_count_'+ad+'_1" id="inner_div_count_'+ad+'_1" value="'+ad+'_1"><input type="hidden" name="early_div_count_'+ad+'_1" id="early_div_count_'+ad+'_1" value="'+ad+'_1_0"><input type="hidden" name="selected_value_'+ad+'" id="selected_value_'+ad+'" value=""><input type="hidden" id="chosen_ad_sc_'+ad+'_1" name="chosen_ad_sc_'+ad+'_1" value=""><input type="hidden" name="last_in_ad_discount_id_'+ad+'" id="last_in_ad_discount_id_'+ad+'" value="'+ad+'_1_0"><input id="last_ad_in_discount_id_'+ad+'" type="hidden" value="'+ad+'_1_0" name="last_ad_in_discount_id_'+ad+'"><input id="last_ad_discount_id_'+ad+'_1" type="hidden" value="0" name="last_ad_discount_id_'+ad+'_1"><table cellpadding="0" cellspacing="0" border="0"><tr>	<td><div class="priceOuterDiv" id="priceOuterDiv_'+ad+'"><table cellpadding="0" cellspacing="0" border="0" id="advance_price_div_'+ad+'_1_0"><tr id="advance_row_'+ad+'_1"><td><div class="lt advancedPriceContainer" id="advanced_PriceContainer_'+ad+'_1" ><div id="schedule_heading_'+ad+'"  class="schedule_heading_1" style="display:none">Chosen Schedule </div><div class="selected_schedule_ad_1" id="selected_schedule_ad_'+ad+'_1" style="display:none"></div><div class="priceRow1_top" style="padding-top:0px;"><div class="lt blackText setWidthPrice3"   style="width: :160px;" id="setWidthPrice3_'+ad+'">Choose Schedule</div><div class="lt blackText setWidthPrice">Payment Period</div><div class="lt blackText setWidthPrice1" id="display_fst_text_'+ad+'_1">Max No. of Hour(s)</div><div class="lt blackText setWidthPrice2" id="display_sec_text_'+ad+'_1" style="display:none;"></div><div class="lt blackText" id="pricelabel_'+ad+'_1">Price</div><div class="clear"></div></div>';
            advance_add+='<div class="clear"></div><div class="priceRow1_bottom"><div class="lt"><select  onchange="choose_schedule('+ad+',\'adv\')" name="choose_schedule_'+ad+'_1" id="choose_schedule_'+ad+'_1" class="drop_down_left width_set7 choose_schedule choose_schedule_'+ad+'_1" style="margin-right: 5px;"><option value="" selected="selected">--Choose--</option></select></div>  ';
            advance_add+='<div class="lt"><select name="ads_payment_'+ad+'_1" id="ad_payment_'+ad+'_1" class="drop_down_left width_set5" onchange="payTypeChanged('+ad+',1,this.value)" onkeyup="payTypeChanged(1,1,this.value)"><option value="Per Hour" >Per Hour</option><option value="Class Card">Class Card</option><option value="Per Session">Per Session</option><option value="Weekly">Weekly</option><option value="Monthly">Monthly</option><option value="Yearly">Yearly</option></select></div>  ';
            advance_add+='<input type="text" id="ad_payment_box_fst_'+ad+'_1" name="ad_payment_box_fst_'+ad+'_1" class="lt textbox" value="Eg: 3" maxlength="5" style="width:107px;margin-right: 5px;" onKeyPress="return number(event);" onfocus="if (this.value==\'Eg: 3\') { this.value = \'\';$(this).css(\'color\',\'#444444\');}"  onblur="if (this.value==\'\'){ this.value = \'Eg: 3\';$(this).css(\'color\',\'#999999\');}" />';
            advance_add+='<input type="text" id="ad_payment_box_sec_'+ad+'_1" name="ad_payment_box_sec_'+ad+'_1" class="lt textbox" value="Eg: 3" maxlength="5" style="display:none;width:100px;margin-right: 5px;" onKeyPress="return number(event);" onfocus="if (this.value==\'Eg: 3\') { this.value = \'\';$(this).css(\'color\',\'#444444\');}"  onblur="if (this.value==\'\'){ this.value = \'Eg: 3\';$(this).css(\'color\',\'#999999\');}" />';
            advance_add+='<input type="text" id="ad_price_'+ad+'_1" name="ad_price_'+ad+'_1" class="lt textbox" value="$" maxlength="7" style="width:100px" onKeyPress="return number(event);" onfocus="if (this.value==\'$\') { this.value = \'\';$(this).css(\'color\',\'#444444\');}"  onblur="if (this.value==\'\'){ this.value = \'$\';$(this).css(\'color\',\'#999999\');}" />';
...
{
    var select_box1="choose_schedule_"+ad+"_"+ad_in;
    // ////alert(select_box1);
    //  var e1 = document.getElementById(select_box1);
    //    ////alert(e1);
    //var strSelected1 = e1.options[e1.selectedIndex].value;
    ...
    var schedules=$('#total_schedule').val();
    schedules=schedules.split("</br>");
    for(k=1;k<schedules.length-1;k++)
    {
        append_sc+= '<option value="' + schedules[k] + '">' + schedules[k] + '</option>';
    }
    ...
    if(yes==1){
        ...
        advance_in_add+='<tr id="advance_row_'+ad+'_'+ad_in+'"><td><div class="lt advancedPriceContainer" id="advanced_PriceContainer_adv_'+ad+'_'+ad_in+'" ><input type="hidden" name="earlybid_decide_adv_'+ad+'_'+ad_in+'" id="earlybid_decide_adv_'+ad+'_'+ad_in+'" value="0"><div   class="schedule_heading_1" style="display:block">Chosen Schedule </div><div class="selected_schedule_ad_1"  style="display:block">'+strSelected1[0]+'</div><b style="font-size:14px;"><input id="choose_schedule_'+ad+'_'+ad_in+'" type="hidden" value="'+strSelected1[1]+'" name="choose_schedule_'+ad+'_'+ad_in+'"></b><div class="clear"></div><div class="priceRow1_top" style="padding-top:0px;"><div class="lt blackText setWidthPrice">Payment Period</div><div class="lt blackText setWidthPrice1" id="display_fst_text_'+ad+'_'+ad_in+'">Max No. of Hour(s)</div><div class="lt blackText setWidthPrice2" id="display_sec_text_'+ad+'_'+ad_in+'" style="display:none;"></div><div class="lt blackText" id="pricelabel_'+ad+'_'+ad_in+'">Price</div><div class="clear"></div></div>';
		
		
        advance_in_add+='<div class="clear"></div><div class="priceRow1_bottom"><div class="lt"><div class="lt"><select  onchange="choose_schedule('+ad+',\'adv\')" name="choose_schedule_'+ad+'_'+ad_in+'" id="choose_schedule_'+ad+'_'+ad_in+'" class="choose_schedule_'+ad+'_'+ad_in+' drop_down_left width_set7 choose_schedule choose_schedule_'+ad+'_'+ad_in+'" style="margin-right: 5px;display:none;"><option value="" selected="selected">--Choose--</option></select><input id="choose_schedule_'+ad+'_'+ad_in+'" type="hidden" value="'+strSelected1+'" name="choose_schedule_'+ad+'_'+ad_in+'"></div>  ';
        ...
        /****************/
        /*advance_in_add+='<div class="staticDiscount_'+ad+'_'+ad_in+'_0" id="staticDiscount_'+ad+'_'+ad_in+'_0"><div class="priceRow2_top"><div class="lt blackText setWidthDiscount">Discount Type and Price</div><div class="lt blackText setWidthDiscount" style="display:none" id="no_sess_'+ad+'_'+ad_in+'_0">Quantity</div><div class="lt blackText setWidthDiscount" style="display:none" id="no_part_'+ad+'_'+ad_in+'_0"style="width:185px">Discount Amount/Percentage</div><div class="clear"></div></div>';
     ...
     */   /**************/
        ...
        var values=$("#last_ad_in_discount_id_"+ad).val();
...
function advance_edit_price(ad){
    // ////alert(ad+'ad');
    myAdvdiv.push(ad);
    //////alert(selected_adv_option+'advs');
    var  advance_add_edit='';
		  
    advance_add_edit+='<div class="priceContainer"  id="priceContainerDiv_'+ad+'"><input type="hidden" name="earlybid_decide_adv_'+ad+'_1" id="earlybid_decide_adv_'+ad+'_1" value="0"><input type="hidden" name="delete_ad_discount_id_'+ad+'_1" id="delete_ad_discount_id_'+ad+'_1" value="'+ad+'_1_0"><input type="hidden" name="inner_div_count_'+ad+'_1" id="inner_div_count_'+ad+'_1" value="'+ad+'_1"><input type="hidden" name="early_div_count_'+ad+'_1" id="early_div_count_'+ad+'_1" value="'+ad+'_1_0"><input type="hidden" name="selected_value_'+ad+'" id="selected_value_'+ad+'" value=""><input type="hidden" id="chosen_ad_sc_'+ad+'_1" name="chosen_ad_sc_'+ad+'_1" value=""><input type="hidden" name="last_in_ad_discount_id_'+ad+'" id="last_in_ad_discount_id_'+ad+'" value="'+ad+'_1_0"><input id="last_ad_in_discount_id_'+ad+'" type="hidden" value="'+ad+'_1_0" name="last_ad_in_discount_id_'+ad+'"><input id="last_ad_discount_id_'+ad+'_1" type="hidden" value="0" name="last_ad_discount_id_'+ad+'_1"><table cellpadding="0" cellspacing="0" border="0"><tr>	<td><div class="priceOuterDiv" id="priceOuterDiv_'+ad+'"><table cellpadding="0" cellspacing="0" border="0" id="advance_price_div_'+ad+'_1_0"><tr><td><div class="lt advancedPriceContainer" id="advanced_PriceContainer_'+ad+'_1" ><div id="schedule_heading_'+ad+'"  class="schedule_heading_1" style="display:none">Chosen Schedule </div><div class="selected_schedule_ad_1" id="selected_schedule_ad_'+ad+'_1" style="display:none"></div><div class="priceRow1_top" style="padding-top:0px;"><div class="lt blackText setWidthPrice3"   style="width: :160px;" id="setWidthPrice3_'+ad+'">Choose Schedule</div><div class="lt blackText setWidthPrice">Payment Period</div><div class="lt blackText setWidthPrice1" id="display_fst_text_'+ad+'_1">Max No. of Hour(s)</div><div class="lt blackText setWidthPrice2" id="display_sec_text_'+ad+'_1" style="display:none;"></div><div class="lt blackText" id="pricelabel_'+ad+'_1">Price</div><div class="clear"></div></div>';
    advance_add_edit+='<div class="clear"></div><div class="priceRow1_bottom"><div class="lt"><select  onchange="choose_schedule('+ad+',\'adv\')" name="choose_schedule_'+ad+'_1" id="choose_schedule_'+ad+'_1" class="choose_schedule_'+ad+'_1 drop_down_left width_set7 choose_schedule" style="margin-right: 5px;"><option value="" selected="selected">--Choose--</option></select></div>  ';
    ...
    advance_add_edit+='<div class="staticDiscount_'+ad+'_1_0"><div class="priceRow2_top"><div class="lt blackText setWidthDiscount">Discount Type and Price</div><div class="lt blackText setWidthDiscount" style="display:none" id="no_sess_'+ad+'_1_0">Quantity</div><div class="lt blackText setWidthDiscount" style="display:none" id="no_part_'+ad+'_1_0"style="width:185px">Discount Amount/Percentage</div><div class="clear"></div></div>';
    advance_add_edit+='<div class="clear"></div><div class="priceRow2_bottom"><div class="lt discout_type" id="discount_type_'+ad+'_1_0"><select name="ad_discount_type_'+ad+'_1_0" id="ad_discount_type_'+ad+'_1_0" class="drop_down_left width_set6" onchange="discTypeChanged(\'\','+ad+',1,0,this.value);$(this).css(\'color\',\'#444444\');" onkeyup="discTypeChanged(\'\',1,1,this.value)"><option value="--Choose Discount Type--" selected="selected">--Choose Discount Type--</option><option value="Early Bird Discount">Early Bird Discount</option><option value="Multiple Session Discount">Multiple Session Discount</option><option value="Multiple Participant Discount">Multiple Participant Discount</option></select></div>   ';
    ...
    advance_add_edit+='<div class="clear"></div></div><div class="clear"></div></div><div class="clear"></div><div class="errorDiv" style="display:none;"><div id="advance_error_'+ad+'_1_0"></div></div><div class="clear"></div><div id="createDynamicDiscount_'+ad+'_1_0"></div></div>';
    advance_add_edit+='</td>';
    ...
    advance_add_edit+='</div><div class="clear"></div></td></tr></table></div><div class="clear"></div></div>';
		
    // $("#add_schedule_"+ad).css("display","none");
    ...
    else if(myAdvdiv.length==myChoose_schedule.length)	//if both netprice div and  schedule are equal
    {
        for(i=0;i<(myAdvdiv.length);i++)
        {
            $(".delete_schedule_adv").css("display","block");
    ...
    else  if((myAdvdiv.length==1)&&(myChoose_schedule.length==1))			// if only one schedule
    {
        $(".delete_schedule_adv").css("display","none");
...
function advance_inner_edit(ad,ad_in)
{
    ...
    advance_in_edit+='<tr id="advance_row_'+ad+'_'+ad_in+'"><td><div class="lt advancedPriceContainer" id="advanced_PriceContainer_'+ad+'_'+ad_in+'" ><input type="hidden" name="earlybid_decide_adv_'+ad+'_'+ad_in+'" id="earlybid_decide_adv_'+ad+'_'+ad_in+'" value="0"><div   class="schedule_heading_1" style="display:block">Chosen Schedule </div><div class="selected_schedule_ad_1" id="selected_schedule_ad_'+ad+'_'+ad_in+'"  style="display:block"></div><b style="font-size:14px;"><input id="choose_schedule_'+ad+'_'+ad_in+'" type="hidden" value="" name="choose_schedule_'+ad+'_'+ad_in+'"></b><div class="clear"></div><div class="priceRow1_top" style="padding-top:0px;"><div class="lt blackText setWidthPrice">Payment Period</div><div class="lt blackText setWidthPrice1" id="display_fst_text_'+ad+'_'+ad_in+'">Max No. of Hour(s)</div><div class="lt blackText setWidthPrice2" id="display_sec_text_'+ad+'_'+ad_in+'" style="display:none;"></div><div class="lt blackText" id="pricelabel_'+ad+'_'+ad_in+'">Price</div><div class="clear"></div></div>';
		
		
    advance_in_edit+='<div class="clear"></div><div class="priceRow1_bottom"><div class="lt"><div class="lt"><select  onchange="choose_schedule('+ad+',\'adv\')" name="choose_schedule_'+ad+'_'+ad_in+'" id="choose_schedule_'+ad+'_'+ad_in+'" class="choose_schedule_'+ad+'_'+ad_in+'  drop_down_left width_set7 choose_schedule1" style="margin-right: 5px;display:none"><option value="" selected="selected">--Choose--</option></select><input type="hidden" name="selected_value_'+ad+'" id="selected_value_'+ad+'" value=""><input id="choose_schedule_'+ad+'_'+ad_in+'" type="hidden" value="" name="choose_schedule_'+ad+'_'+ad_in+'"></div>  ';
