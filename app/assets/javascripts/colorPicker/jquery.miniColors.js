	...
	$.extend($.fn, {
		...
		miniColors: function(o, data) {
			...
			function create(input, o, data) {
				...
				// Create trigger
				trigger = $('<span class="miniColors-trigger" style=""></span>');
				$("#setbg").show();
				$("#setbg").css("backgroundColor",color);
			...
			function show(input) {
				...
				selector = $('<div class="miniColors-selector"></div>')
					...
					.append('<div class="miniColors-colors" ><div class="miniColors-colorPicker"><div class="miniColors-colorPicker-inner"></div></div>')
					.css('display', 'none')
